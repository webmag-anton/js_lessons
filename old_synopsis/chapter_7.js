...
// // Т.к нет св-ва name, то ошибка(SyntaxError) бросается в catch, а там идет 
// // проверка - если имя ошибки SyntaxError, то обрабатывается, а если другой 
// // вид ошибки - то выбрасыватся наружу (в консоль или «более внешний» try..catch )  

// var data = '{"age": 30 }'; // данные корректны
