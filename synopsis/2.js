...
// Событие focus/blur не всплывают, но можно использовать или фазу перехвата (погружения), 
...
elem.focus() - устанавливают фокус элемету
elem.blur() - снимают фокус элемету
...
tabindex="-1" - позволяет фокусироваться на элементе только программно {Tab не сработает} 
