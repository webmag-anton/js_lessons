...
elem.outerHTML - внутреннее HTML-содержимое узла-элемента;
node.data - cодержимое узла-неэлемента: текста, комментария;
elem.textContent - читает ткст без учета тегов; записывает «как текст»
...
elem.dataset.about - доступно чтение и изменение
