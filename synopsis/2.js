...
// при всплытии любой промежуточный обработчик может решить, что событие полностью обработано, 
// и остановить всплытие методом event.stopPropagation(); метод event.stopImmediatePropagation() 
