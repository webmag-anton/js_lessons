...
// вместо new Event ( new MouseEvent("click") ). Специфический конструктор позволяет  
// указать стандартные свойства для данного типа события (clientX/clientY для события мыши)
